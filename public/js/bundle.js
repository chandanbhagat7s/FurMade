    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _axios.default.post('http://127.0.0.1:3000/api/v1/product', _objectSpread({}, product));
        case 3:
          res = _context3.sent;
          console.log(res);
          if (res.data.status && res.data.status == 'success') {
...
if (addProductform) {
  addProductform.addEventListener('submit', function (e) {
    ...
    var imageFile1 = document.getElementById('imageFile1').value;
    var imageFile2 = document.getElementById('imageFile2').value;
    var imageFile3 = document.getElementById('imageFile3').value;
    ...
    console.log(product);
    // console.log(email, password, cnfPassword, mobile);
    if (!product.price || !product.type || !product.colors || !product.deliveredIn || !product.dileveryCharges || !product.paymentMethod || !product.warranty || !product.coverImage || !product.summery || !product.about || !product.Images || !product.features || !product.dim || !product.replacmentIn) {
      return (0, _alert.alertt)('danger', 'please provide all the details');
    }
    (0, _functions.addNewProduct)(product);
  });
}
if (deletProductForm) {
